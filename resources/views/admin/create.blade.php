...
@section('title', 'Tambah Buku Baru - PustakaDigital')
    ...
    <div class="col-xl-9 col-lg-10 fade-in-up">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                ...
                <p class="text-muted mb-0">Silakan isi formulir di bawah ini untuk menambahkan koleksi.</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-4">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" required placeholder="Contoh: Belajar Pemrograman Web Laravel">
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3 mb-md-0">
                        ...
                        <input type="text" class="form-control" id="author" name="author" value="{{ old('author') }}" required placeholder="Nama Penulis">
                    </div>
                    <div class="col-md-6">
                        <label for="publisher" class="form-label">Penerbit</label>
                        <input type="text" class="form-control" id="publisher" name="publisher" value="{{ old('publisher') }}" placeholder="Nama Penerbit (Opsional)">
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="5" required placeholder="Tuliskan deskripsi singkat mengenai buku ini...">{{ old('description') }}</textarea>
                </div>

                <h5 class="fw-bold mb-4 border-bottom pb-2">Sumber Buku (Pilih Opsi)</h5>
                
                <div class="source-toggle mb-4">
                    <input type="radio" class="btn-check" name="source_type" id="source_pdf" value="pdf" checked>
                    <label class="btn" for="source_pdf"><i class="bi bi-file-earmark-pdf me-2"></i>Upload PDF</label>

                    <input type="radio" class="btn-check" name="source_type" id="source_link" value="link">
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3 mb-md-0">
                        ...
                        <div class="file-upload-wrapper" id="cover-wrapper">
                            <i class="bi bi-image file-icon"></i>
                            <h6 class="mb-1" id="cover-filename">Klik untuk memilih gambar</h6>
                            <p class="small text-muted mb-0">Format: JPG, PNG, WEBP (Maks. 2MB)</p>
                    ...
                    <div class="col-md-6">
                        <!-- PDF Input Section -->
                        <div id="pdf-section">
                            <label class="form-label">File Buku (PDF) <span class="text-danger">*</span></label>
                            <div class="file-upload-wrapper" id="pdf-wrapper">
                                <i class="bi bi-file-earmark-pdf file-icon text-danger"></i>
                                <h6 class="mb-1" id="pdf-filename">Klik untuk memilih file PDF</h6>
                        ...
                        <div id="link-section" style="display: none;">
                            <label for="external_link" class="form-label">Link Buku (URL) <span class="text-danger">*</span></label>
                            <div class="input-group mb-2">
                                <span class="input-group-text bg-transparent"><i class="bi bi-link-45deg"></i></span>
                                <input type="url" class="form-control" id="external_link" name="external_link" placeholder="https://example.com/buku..." value="{{ old('external_link') }}">
                            </div>
                ...
                <div class="d-flex justify-content-end gap-3 mt-5">
                    ...
                    <button type="submit" class="btn btn-primary rounded-pill px-5"><i class="bi bi-save me-2"></i> Simpan Buku</button>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        coverInput.addEventListener('change', function(e) {
            if(this.files && this.files[0]) {
                ...
                coverFilename.classList.add('text-primary');
        ...
        pdfInput.addEventListener('change', function(e) {
            if(this.files && this.files[0]) {
                ...
                pdfFilename.classList.add('text-primary');
            }
        });
    });
</script>
